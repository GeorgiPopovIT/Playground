...
namespace Positive_Or_Negative_Opinion
{
    public partial class Positive_Negative
    {
        public const string RetrainFilePath =  @"C:\Users\Georges\Desktop\Tests.Net\Playground\ML.NET-Test\Positive_Or_Negative_Opinion\opinions.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.0346291F,L2Regularization=0.2231379F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
