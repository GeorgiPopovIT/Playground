...
[
	new(1, "OLD Laptop", 999.99m, 10),
	new(2, "OLD Mouse", 29.99m, 50),
	new(3, "OLD Keyboard", 79.99m, 30)
];

List<User> users =
[
	new(1, "OLD John Doe", "john@example.com"),
	new(2, "OLD Jane Smith", "jane@example.com")
];
...
app.MapPost("/products", (ProductDto dto) =>
{
	var newProduct = new Product(
		products.Count != 0 ? products.Max(p => p.Id) + 1 : 1,
		dto.Name,
		dto.Price,
		dto.Stock
	);
